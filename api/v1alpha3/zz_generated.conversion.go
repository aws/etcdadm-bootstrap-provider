...
func autoConvert_v1beta1_BottlerocketConfig_To_v1alpha3_BottlerocketConfig(in *v1beta1.BottlerocketConfig, out *BottlerocketConfig, s conversion.Scope) error {
	out.EtcdImage = in.EtcdImage
	out.BootstrapImage = in.BootstrapImage
	// WARNING: in.AdminImage requires manual conversion: does not exist in peer-type
	// WARNING: in.ControlImage requires manual conversion: does not exist in peer-type
	out.PauseImage = in.PauseImage
	// WARNING: in.CustomHostContainers requires manual conversion: does not exist in peer-type
	// WARNING: in.CustomBootstrapContainers requires manual conversion: does not exist in peer-type
	return nil
}
...
func autoConvert_v1alpha3_EtcdadmConfigSpec_To_v1beta1_EtcdadmConfigSpec(in *EtcdadmConfigSpec, out *v1beta1.EtcdadmConfigSpec, s conversion.Scope) error {
	...
	if in.RegistryMirror != nil {
		...
		*out = new(v1beta1.RegistryMirrorConfiguration)
		if err := Convert_v1alpha3_RegistryMirrorConfiguration_To_v1beta1_RegistryMirrorConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.RegistryMirror = nil
	}
...
func autoConvert_v1beta1_EtcdadmConfigSpec_To_v1alpha3_EtcdadmConfigSpec(in *v1beta1.EtcdadmConfigSpec, out *EtcdadmConfigSpec, s conversion.Scope) error {
	...
	if in.RegistryMirror != nil {
		...
		*out = new(RegistryMirrorConfiguration)
		if err := Convert_v1beta1_RegistryMirrorConfiguration_To_v1alpha3_RegistryMirrorConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.RegistryMirror = nil
