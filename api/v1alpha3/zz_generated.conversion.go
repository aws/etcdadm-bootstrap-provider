//go:build !ignore_autogenerated_etcd_bootstrap
...
func autoConvert_v1alpha3_BottlerocketBootstrapContainer_To_v1beta1_BottlerocketBootstrapContainer(in *BottlerocketBootstrapContainer, out *v1beta1.BottlerocketBootstrapContainer, s conversion.Scope) error {
	out.Name = in.Name
	out.Image = in.Image
...
// Convert_v1alpha3_BottlerocketBootstrapContainer_To_v1beta1_BottlerocketBootstrapContainer is an autogenerated conversion function.
func Convert_v1alpha3_BottlerocketBootstrapContainer_To_v1beta1_BottlerocketBootstrapContainer(in *BottlerocketBootstrapContainer, out *v1beta1.BottlerocketBootstrapContainer, s conversion.Scope) error {
	return autoConvert_v1alpha3_BottlerocketBootstrapContainer_To_v1beta1_BottlerocketBootstrapContainer(in, out, s)
}

func autoConvert_v1beta1_BottlerocketBootstrapContainer_To_v1alpha3_BottlerocketBootstrapContainer(in *v1beta1.BottlerocketBootstrapContainer, out *BottlerocketBootstrapContainer, s conversion.Scope) error {
	out.Name = in.Name
	out.Image = in.Image
	out.Essential = in.Essential
	out.Mode = in.Mode
...
// Convert_v1beta1_BottlerocketBootstrapContainer_To_v1alpha3_BottlerocketBootstrapContainer is an autogenerated conversion function.
func Convert_v1beta1_BottlerocketBootstrapContainer_To_v1alpha3_BottlerocketBootstrapContainer(in *v1beta1.BottlerocketBootstrapContainer, out *BottlerocketBootstrapContainer, s conversion.Scope) error {
	return autoConvert_v1beta1_BottlerocketBootstrapContainer_To_v1alpha3_BottlerocketBootstrapContainer(in, out, s)
}
...
func autoConvert_v1alpha3_BottlerocketConfig_To_v1beta1_BottlerocketConfig(in *BottlerocketConfig, out *v1beta1.BottlerocketConfig, s conversion.Scope) error {
	...
	out.AdminImage = in.AdminImage
	out.ControlImage = in.ControlImage
	...
	out.Boot = (*apiv1beta1.BottlerocketBootSettings)(unsafe.Pointer(in.Boot))
	return nil
}
...
func autoConvert_v1alpha3_BottlerocketHostContainer_To_v1beta1_BottlerocketHostContainer(in *BottlerocketHostContainer, out *v1beta1.BottlerocketHostContainer, s conversion.Scope) error {
	out.Name = in.Name
...
// Convert_v1alpha3_BottlerocketHostContainer_To_v1beta1_BottlerocketHostContainer is an autogenerated conversion function.
func Convert_v1alpha3_BottlerocketHostContainer_To_v1beta1_BottlerocketHostContainer(in *BottlerocketHostContainer, out *v1beta1.BottlerocketHostContainer, s conversion.Scope) error {
	return autoConvert_v1alpha3_BottlerocketHostContainer_To_v1beta1_BottlerocketHostContainer(in, out, s)
}

func autoConvert_v1beta1_BottlerocketHostContainer_To_v1alpha3_BottlerocketHostContainer(in *v1beta1.BottlerocketHostContainer, out *BottlerocketHostContainer, s conversion.Scope) error {
	out.Name = in.Name
	out.Superpowered = in.Superpowered
	out.Image = in.Image
	out.UserData = in.UserData
...
// Convert_v1beta1_BottlerocketHostContainer_To_v1alpha3_BottlerocketHostContainer is an autogenerated conversion function.
func Convert_v1beta1_BottlerocketHostContainer_To_v1alpha3_BottlerocketHostContainer(in *v1beta1.BottlerocketHostContainer, out *BottlerocketHostContainer, s conversion.Scope) error {
	return autoConvert_v1beta1_BottlerocketHostContainer_To_v1alpha3_BottlerocketHostContainer(in, out, s)
}
...
func autoConvert_v1alpha3_EtcdadmConfigList_To_v1beta1_EtcdadmConfigList(in *EtcdadmConfigList, out *v1beta1.EtcdadmConfigList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1beta1.EtcdadmConfig, len(*in))
		for i := range *in {
			if err := Convert_v1alpha3_EtcdadmConfig_To_v1beta1_EtcdadmConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1beta1_EtcdadmConfigList_To_v1alpha3_EtcdadmConfigList(in *v1beta1.EtcdadmConfigList, out *EtcdadmConfigList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]EtcdadmConfig, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_EtcdadmConfig_To_v1alpha3_EtcdadmConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
